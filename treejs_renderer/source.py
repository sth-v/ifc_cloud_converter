...
HEADER = """
<head>
    <title>ContextMachine Internal Views</title>
    <meta name='tool' content='pythonocc - @VERSION@ , WebGl'>
    <meta name='Author' content='Andrew Astakhov - aa@contextmachine.com'>
    <meta name='Keywords' content='CONTEXTMACHINE, mmodel,MasterModel,Ifc'>
    <meta charset="utf-8">
    <style>
        body {
...
class HTMLHeader:
    def __init__(self, bg_gradient_color1="#161E39", bg_gradient_color2="#263650"):
...
class ThreejsRenderer:
    ...
    def DisplayShape(self,
        ...
        self._3js_shapes[shape_hash] = [export_edges, color, specular_color, shininess, transparency, line_color,
                                        line_width]
        # generate the mesh
